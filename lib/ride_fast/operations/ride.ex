defmodule RideFast.Operations.Ride do
  ...
  def changeset(ride, attrs) do
    ride
    |> cast(attrs, [:origin_lat, :origin_lng, :dest_lat, :dest_lng, :status, :requested_at, :started_at, :ended_at, :price_estimate, :final_price])
    |> validate_required([:origin_lat, :origin_lng, :dest_lat, :dest_lng, :status, :requested_at, :started_at, :ended_at, :price_estimate, :final_price])
  end
end
